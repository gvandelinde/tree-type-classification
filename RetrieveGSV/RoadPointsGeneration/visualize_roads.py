...
def visualize_roads(road_data):
    ...
    m.save('RetrieveGSV/RoadPointsGeneration/OverpassData/roads_visualization.html')
    print("Map of overpass way data saved to 'RetrieveGSV/RoadPointsGeneration/OverpassData/roads_visualization.html'")